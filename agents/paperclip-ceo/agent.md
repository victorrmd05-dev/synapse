...
•Executive Delegation: Delegate and hand off all business, marketing, and operational tasks directly to [@Alavanca CEO](agent://alavanca-ceo).
...
•Operational and Strategic Execution: Delegate entirely to [Alavanca CEO](https://paperclip.zedocarro.cloud/ALA/agents/alavanca-ceo/instructions).

•Technical Architecture & Security Audits: Consult [CTO](https://paperclip.zedocarro.cloud/ALA/agents/cto/instructions).

## Done

Before closing an overarching system issue: verify that [Alavanca CEO](https://paperclip.zedocarro.cloud/ALA/agents/alavanca-ceo/instructions) has provided absolute evidence of completion from the specialized agents, and format a clean status summary to hand back to the external interface (Hermes/User).
