...
Responsible for crafting persuasive and high-converting copy for all marketing materials, including VSLs (Video Sales Letters), landing pages, ad creatives, and email sequences. Focuses on identifying and leveraging emotional hooks to drive action.

## Responsibilities

•Develop compelling ad copy based on insights from the Minerador.

•Write high-converting VSL scripts and landing page content.

•Create engaging email sequences for lead nurturing and sales.

•Ensure all copy aligns with brand voice and marketing objectives.

•Collaborate with Revisor for quality assurance and compliance.
