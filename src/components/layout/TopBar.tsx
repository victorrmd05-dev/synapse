...
interface TopBarProps {
  ...
  onSync?: () => void;
  isSyncing?: boolean;
  /** Slot à esquerda dos botões (ex.: seletor de data). */
  actions?: React.ReactNode;
}

export function TopBar({ title, subtitle, onSync, isSyncing, actions }: TopBarProps) {
  return (
    <header className="flex items-center justify-between pb-6 border-b border-[#2A2A38] mb-6 gap-4">
      <div>
